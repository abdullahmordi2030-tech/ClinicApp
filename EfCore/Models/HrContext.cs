...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__countrie__7E8CD055993FEF86");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__departme__C2232422DD6EDD13");
        ...
        {
            entity.HasKey(e => e.DependentId).HasName("PK__dependen__F25E28CE0FE62B84");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__employee__C52E0BA8EF220791");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A58416DCD5");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__location__771831EAE7AFBEBB");
        ...
        {
            entity.HasKey(e => e.RegionId).HasName("PK__regions__01146BAEEB30E485");
